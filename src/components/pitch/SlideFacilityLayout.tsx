...
export default function SlideFacilityLayout({ active }: { active: boolean }) {
  const zones = [
    ...
    { name: "Field & Court Sports", size: "8,000 sq ft", desc: "Basketball, volleyball, soccer, football, lacrosse, baseball cages", icon: "🏀", color: "border-accent bg-accent/10" },
  ...
  const stats = [
    { label: "Total Facility", value: "60,000+ sq ft" },
    { label: "Training Zones", value: "10 Distinct" },
  ...
  const mapZones = [
    { name: "Main Training", icon: "🏋", x: "3%", y: "3%", w: "46%", h: "28%", color: "border-primary bg-primary/10" },
    { name: "Track & Field", icon: "🏃", x: "51%", y: "3%", w: "46%", h: "28%", color: "border-accent bg-accent/10" },
    { name: "Cross-Training", icon: "⚡", x: "3%", y: "33%", w: "30%", h: "22%", color: "border-primary bg-primary/10" },
    { name: "Field & Court", icon: "🏀", x: "35%", y: "33%", w: "32%", h: "22%", color: "border-accent bg-accent/10" },
    { name: "Swimming", icon: "🏊", x: "69%", y: "33%", w: "28%", h: "22%", color: "border-primary bg-primary/10" },
    { name: "Film & Stunt", icon: "🎬", x: "3%", y: "57%", w: "35%", h: "20%", color: "border-accent bg-accent/10" },
    { name: "Recovery", icon: "❄️", x: "40%", y: "57%", w: "28%", h: "20%", color: "border-primary bg-primary/10" },
    { name: "Medical", icon: "🏥", x: "70%", y: "57%", w: "27%", h: "20%", color: "border-accent bg-accent/10" },
    { name: "Seminar Hall", icon: "🎓", x: "3%", y: "79%", w: "32%", h: "18%", color: "border-primary bg-primary/10" },
    { name: "Golf & Specialty", icon: "⛳", x: "37%", y: "79%", w: "30%", h: "18%", color: "border-accent bg-accent/10" },
  ];
