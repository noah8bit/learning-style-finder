...
export default function SlidePreOpeningRisk({ active }: { active: boolean }) {
  const mitigations = [
    { icon: "💰", title: "12-Month Operating Reserve", desc: "Included within the $15–16M raise. Covers initial operating losses during membership ramp without requiring additional capital.", color: "text-primary", borderColor: "border-primary/30" },
