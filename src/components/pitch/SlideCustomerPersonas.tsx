...
export default function SlideCustomerPersonas({ active }: { active: boolean }) {
  const personas = [
    ...
    { icon: "🎬", name: "Film, Stunt & Circus", age: "22–45", desc: "Touring circus and live production performers operating in Georgia", needs: ["Stunt rigging & choreography", "Aerial silks & trapeze"] },
