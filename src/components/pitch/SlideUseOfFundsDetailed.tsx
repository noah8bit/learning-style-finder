        ...
        <div className="w-[58%] flex flex-col justify-center px-[80px]">
          {active && (
            <>
              ...
              <div className="animate-fade-up stagger-4 mt-4 bg-secondary border-2 border-primary/40 rounded-xl p-5 flex items-center justify-between">
                <span className="text-foreground text-[22px] font-bold uppercase tracking-wider">Total Raise</span>
                <span className="text-primary text-[36px] font-bold">$750,000</span>
              </div>
            </>
          )}
        </div>
