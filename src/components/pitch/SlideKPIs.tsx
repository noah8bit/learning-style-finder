...
export default function SlideKPIs({ active }: { active: boolean }) {
  const kpis = [
    ...
    { icon: "⏱️", metric: "Break-Even", target: "245 members", desc: "Assuming Year 1 medical, team retainers, and ancillary revenue maintained at conservative levels", color: "text-accent" },
  ];
