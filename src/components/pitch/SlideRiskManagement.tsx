...
export default function SlideRiskManagement({ active }: { active: boolean }) {
  const risks = [
    ...
    { risk: "Economic Downturn", level: "Medium", levelColor: "text-yellow-400 bg-yellow-400/10", mitigation: "Diversified revenue streams. Insurance-backed medical revenue provides recession resistance. NMT services begin Month 1. Insurance reimbursement begins Month 2–3 following credentialing and billing cycle.", icon: "📉" },
    { risk: "Low Initial Membership", level: "Medium", levelColor: "text-yellow-400 bg-yellow-400/10", mitigation: "150+ pre-sale target before opening. $350K development reserve. Conservative Year 1 model assumes only 200 avg members.", icon: "📊" },
