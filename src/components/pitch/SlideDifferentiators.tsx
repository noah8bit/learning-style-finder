...
export default function SlideDifferentiators({ active }: { active: boolean }) {
  const diffs = [
    ...
    { icon: "🎪", title: "Film, Stunt & Circus Wing", benefit: "Designed to support touring production and stunt professionals working in Georgia's film ecosystem — aerial silks, trapeze, acrobatic training, and stunt coordination." },
