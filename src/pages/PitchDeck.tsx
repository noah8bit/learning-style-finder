...
function SlideProblem({ active }: { active: boolean }) {
  const problems = [
    ...
    { icon: "🌟", title: "Community Outreach", desc: "Reaching gifted athletes in the Atlanta community is deeply important to us. Through active outreach, scouting, and mentorship programs, Iron Form ensures raw talent doesn't go unnoticed or unsupported." },
  ];
  return (
    <ScaledSlide>
